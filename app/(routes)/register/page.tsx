        ...
        <main className="w-full h-screen pb-16 gap-10 flex flex-col justify-between py-4 px-8 relative">
            ...
            <div className="flex flex-col flex-grow self-stretch justify-between">
                <div className="flex justify-between items-center text-3xl text-amber-400 font-semibold">
                    ...
                    <span className='text-3xl text-amber-400 font-semibold'>1/3</span>
                </div>
                <div className="flex flex-col gap-6">
                    <h1 className='text-3xl font-normal'>¡Hola, Juan!</h1>
                    {
                        !codeSent ? <div className="flex items-center gap-6 rounded-md bg-amber-50 text-amber-400 p-6">
                            <span className='text-2xl'>
                                <FontAwesomeIcon icon={faInfoCircle}/>
                            </span>
                            <h2 className='font-medium'>Utilizaremos tu correo para enviarte mensajes importantes.</h2>
                ...
                <button onClick={() => codeSent ? router.push('/register/phone') : setCodeSent(true)} className='py-2 font-semibold bg-amber-400 text-white rounded-xl uppercase'>
